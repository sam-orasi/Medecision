...
////            	System.out.println(key + ", " + By.cssSelector(properties.getProperty(key)));
//            }
//        } 
//        catch (Exception x) {
//            x.printStackTrace();
...
//    }
//    
//    public AutomationTest(String url) {
//      
//        baseUrl = url;
...
//     * @return
//     */
//    public AutomationTest waitForWindow(String regex, int maxAttempts) {
//    	Set<String> windows = driver.getWindowHandles();
//
//        for (String window : windows) {
//            try {
...
//     * @return
//     */
//    public AutomationTest switchToTopWindow() {
...
//     * @return
//     */
//    public AutomationTest openNewTab() {
...
//    }
//    
//    public AutomationTest openNewWindow() {
///*    	WebElement body = driver.findElement(By.tagName("body"));
//    	String ctrlT = Keys.chord(Keys.CONTROL, "t");
//    	body.sendKeys(ctrlT);*/
//    	
...
//     * @return
//     */
//    public AutomationTest waitFor(By by, int waitTime) {
...
//     * @return
//     */
//    public AutomationTest contextClick(By by) {
...
//    
//    
//    public AutomationTest orderByAllColumns(By by) {
//
//    	for (int i=2; i<10; i++)
//    	{
...
//    }
//    
//    public AutomationTest orderBy(By by) {
...
//    }
//    
//    public AutomationTest sendKeys(By by, Keys keys) {
//    	
...
//    }
//    
//    public AutomationTest timeout(int sec) {
//    	int ms=sec*1000;
...
//    }
//    
//    public AutomationTest injectMockCase(int caseNo, String flagStatus, String scenario) {
//    	this
...
//    }
//    
//    public AutomationTest scanFile(String docType, String option) {
//		this
...
//    }
//    
//    public AutomationTest clickFirstEntryInTable() {
//    	this
//    	.switchToTopWindow()
...
//    }
//    
//    public AutomationTest clickMonitorTR() {
//    	this
...
//    }
//    
//    public AutomationTest loginAs(String usr, String pwd) {
//    	
//    	this
...
//    }
//    
//    public AutomationTest closeMonitor() {
//    	this
...
//    }
//    
//    public AutomationTest search(String searchStr) {
//    	this
//    	.switchToFrame("workAreaFrame")
//    	.switchToFrame("frame1000233")  	
